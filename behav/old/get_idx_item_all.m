...
%perpare data
        ...
        %% get indexes
        %mem
        idx_mem_D=find(mem_all_pID1==t & mem_all_pID1==mem_all_pID2 & mem_all_wID1~=mem_all_wID2);%%same face different words: p+c-
        idx_mem_DB_all=find(mem_all_pID1==t & mem_all_mem2==1 & mem_all_pID1~=mem_all_pID2 & mem_check_run==1 & mem_check_set==0);
        idx_mem_DB_wc=find(mem_all_pID1==t & mem_all_mem2==1 & mem_all_pID1~=mem_all_pID2 & mem_check_run==1 & mem_check_set==0 & mem_check_cate==1);
        %ln
        idx_ln_D=find(ln_all_pID1==t & ln_all_pID1==ln_all_pID2 & ln_all_wID1~=ln_all_wID2);%%same face different words: p+c-
        idx_ln_DB_all=find(ln_all_pID1==t & ln_all_mem2==1 & ln_all_pID1~=ln_all_pID2 & ln_check_run==1 & ln_check_set==0);
        idx_ln_DB_wc=find(ln_all_pID1==t & ln_all_mem2==1 & ln_all_pID1~=ln_all_pID2 & ln_check_run==1 & ln_check_set==0 & ln_check_cate==1);
end %end func
