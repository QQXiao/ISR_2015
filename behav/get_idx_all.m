function [idx_mem_D,idx_mem_DB_all,idx_mem_DB_wc,idx_ln_D,idx_ln_DB_all,idx_ln_DB_wc,m_ln,m_mem]=get_idx(s)
...
%perpare data
	...
	m_mem=list_submem(:,MpID);
       ...
       for k=2:TN
        ...
        %% get indexes
        %mem
        idx_mem_D=find(all_phase1==2 & all_phase2==2 & all_pID1==all_pID2 & all_wID1~=all_wID2);%%same face different words: p+c-
        idx_mem_DB_all=find(all_phase1==2 & all_phase2==2 & all_pID1~=all_pID2 & check_run==1 & check_set==0);
        idx_mem_DB_wc=find(all_phase1==2 & all_phase2==2 & all_pID1~=all_pID2 & check_run==1 & check_set==0 & check_cate==1);
        %ln
