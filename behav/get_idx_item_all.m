...
%perpare data
        ...
        idx_mem_DB_all=find(mem_all_pID1==t & mem_all_pID1~=mem_all_pID2 & mem_check_run==1 & mem_check_set==0);
        idx_mem_DB_wc=find(mem_all_pID1==t & mem_all_pID1~=mem_all_pID2 & mem_check_run==1 & mem_check_set==0 & mem_check_cate==1);
        %ln
