...
for s=subs
	for hd=1:2
		for hr=1:2	
		[idx_ERS_I,idx_ERS_IB_all,idx_ERS_IB_wc,idx_ERS_D,idx_ERS_DB_all,idx_ERS_DB_wc,idx_mem_D,idx_mem_DB_all,idx_mem_DB_wc,idx_ln_D,idx_ln_DB_all,idx_ln_DB_wc,m_ln,m_mem]= get_idx_sep_13_24(s,hr);
		tn=[60:5:95];
		for n=1:length(tn)
		nn=tn(n);
		...
		half_data_vln=data_vln([1:24 49:72 97:120 145:168]+24*(hr-1),:);
        	...
        	ln_ln(n,3)=mean(ln_cc(idx_ln_DB_all));
                ...
                half_data_vmem=data_vmem([1:24 49:72 97:120 145:168]+24*(hr-1),:);
