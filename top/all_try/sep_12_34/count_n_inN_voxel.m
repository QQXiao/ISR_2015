...
datadir=sprintf('%s/top/tmap/data/number_based',basedir);
resultdir=sprintf('%s/top/tmap/data/number_based',basedir);
subs=setdiff([1:21],2);
for s=subs
        for h=1:2
...
file_name=sprintf('%s/num_inN_voxels', resultdir);
