...
TN=192;
subs=setdiff(1:21,2);
resultdir=sprintf('%s/peak/VVC/data/top/ps/ROI_based/inform/mem',basedir);
...
[idx_ERS_I,idx_ERS_IB_all,idx_ERS_IB_wc,idx_ERS_D,idx_ERS_DB_all,idx_ERS_DB_wc,idx_mem_D,idx_mem_DB_all,idx_mem_DB_wc,idx_ln_D,idx_ln_DB_all,idx_ln_DB_wc,m_ln,m_mem]= get_idx(s);
        ...
        ln_file1=sprintf('%s/p95_mem_sub%02d_set1.mat', lndir,s);                                                       
        load(ln_file1); ln_set1=mem_tcc1;                                                                                   
        ln_file2=sprintf('%s/p95_mem_sub%02d_set2.mat', lndir,s);                                                       
        load(ln_file2); ln_set2=mem_tcc2;        
	%get fMRI data
