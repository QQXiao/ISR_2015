...
resultdir=sprintf('%s/ROI_based/within_between',basedir,nroi);
for s=subs;
cc_ln_ln1=[];
cc_mem_mem1=[];
cc_ln_ln2=[];
...
idx_mem_D,idx_mem_DB_all,idx_mem_DB_wc,idx_ln_D,idx_ln_DB_all,idx_ln_DB_wc,m_ln,m_mem]= get_idx(s);
...
all_idx=1:TN*(TN-1)/2;
all_pID1=[]; all_pID2=[]; all_mem1=[]; all_mem2=[]; all_phase1=[];
all_phase2=[]; check_run=[]; check_set=[]; all_run1=[];all_run2=[];
for k=2:TN
...
idx_ln1=find(all_phase1==1 & all_phase2==1 & all_run1==1  & all_pID1~=all_pID2 ...
& check_run==1 & check_set==0 & all_mem1==1 & all_mem2==1);
idx_ln2=find(all_phase1==1 & all_phase2==1 & all_run1==2  & all_pID1~=all_pID2 ...
& check_run==1 & check_set==0 & all_mem1==1 & all_mem2==1);
idx_mem1=find(all_phase1==2 & all_phase2==2 & all_run1==1 & all_pID1~=all_pID2 ...
& check_run==1 & check_set==0 & all_mem1==1 & all_mem2==1);
idx_mem2=find(all_phase1==2 & all_phase2==2 & all_run1==2 & all_pID1~=all_pID2 ...
& check_run==1 & check_set==0 & all_mem1==1 & all_mem2==1);
        %get fMRI data
