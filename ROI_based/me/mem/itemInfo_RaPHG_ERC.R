...
subdata <- item_data
itemInfo_actmean <- lmer(RaPHG_rsadiff~ERC_actmean+(1+ERC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RaPHG_rsadiff~1+(1+ERC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RaPHG_rsadiff~ERC_actmean+(1+ERC_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RaPHG_rsadiff~1+(1+ERC_rsadiff|subid),REML=FALSE,data=subdata)
