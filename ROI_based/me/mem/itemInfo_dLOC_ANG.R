...
itemInfo_actmean <- lmer(dLOC_rsadiff~ANG_actmean+(1+ANG_actmean|subid)+(1+ANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~1+(1+ANG_actmean|subid)+(1+ANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(dLOC_rsadiff~ANG_actrep+(1+ANG_actrep|subid)+(1+ANG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(dLOC_rsadiff~1+(1+ANG_actrep|subid)+(1+ANG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~ANG_rsadiff+(1+ANG_rsadiff|subid)+(1+ANG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~1+(1+ANG_rsadiff|subid)+(1+ANG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsadiff~ANG_rsaD+(1+ANG_rsaD|subid)+(1+ANG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsadiff~1+(1+ANG_rsaD|subid)+(1+ANG_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(dLOC_rsaD~ANG_actmean+(1+ANG_actmean|subid)+(1+ANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~1+(1+ANG_actmean|subid)+(1+ANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(dLOC_rsaD~ANG_actrep+(1+ANG_actrep|subid)+(1+ANG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(dLOC_rsaD~1+(1+ANG_actrep|subid)+(1+ANG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(dLOC_rsaD~ANG_rsadiff+(1+ANG_rsadiff|subid)+(1+ANG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(dLOC_rsaD~1+(1+ANG_rsadiff|subid)+(1+ANG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(dLOC_rsaD~ANG_rsaD+(1+ANG_rsaD|subid)+(1+ANG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(dLOC_rsaD~1+(1+ANG_rsaD|subid)+(1+ANG_rsaD|pid),REML=FALSE,data=subdata)
