...
itemInfo_actmean <- lmer(dLOC_rsadiff~ERC_actmean+(1+ERC_actmean|subid)+(1+ERC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~1+(1+ERC_actmean|subid)+(1+ERC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(dLOC_rsadiff~ERC_actrep+(1+ERC_actrep|subid)+(1+ERC_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(dLOC_rsadiff~1+(1+ERC_actrep|subid)+(1+ERC_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~ERC_rsadiff+(1+ERC_rsadiff|subid)+(1+ERC_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~1+(1+ERC_rsadiff|subid)+(1+ERC_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsadiff~ERC_rsaD+(1+ERC_rsaD|subid)+(1+ERC_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsadiff~1+(1+ERC_rsaD|subid)+(1+ERC_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(dLOC_rsaD~ERC_actmean+(1+ERC_actmean|subid)+(1+ERC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~1+(1+ERC_actmean|subid)+(1+ERC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(dLOC_rsaD~ERC_actrep+(1+ERC_actrep|subid)+(1+ERC_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(dLOC_rsaD~1+(1+ERC_actrep|subid)+(1+ERC_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(dLOC_rsaD~ERC_rsadiff+(1+ERC_rsadiff|subid)+(1+ERC_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(dLOC_rsaD~1+(1+ERC_rsadiff|subid)+(1+ERC_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(dLOC_rsaD~ERC_rsaD+(1+ERC_rsaD|subid)+(1+ERC_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(dLOC_rsaD~1+(1+ERC_rsaD|subid)+(1+ERC_rsaD|pid),REML=FALSE,data=subdata)
