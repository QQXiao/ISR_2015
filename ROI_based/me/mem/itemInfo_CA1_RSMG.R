...
subdata <- item_data
itemInfo_actmean <- lmer(RSMG_rsadiff~RSMG_actmean+(1+RSMG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RSMG_rsadiff~1+(1+RSMG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RSMG_rsadiff~RSMG_actmean+(1+RSMG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RSMG_rsadiff~1+(1+RSMG_rsadiff|subid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_RSMG_RSMG.txt",sep="\t")
