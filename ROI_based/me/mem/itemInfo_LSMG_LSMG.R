...
subdata <- item_data
itemInfo_actmean <- lmer(LSMG_rsadiff~LSMG_actmean+(1+LSMG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LSMG_rsadiff~1+(1+LSMG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LSMG_rsadiff~LSMG_actmean+(1+LSMG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LSMG_rsadiff~1+(1+LSMG_rsadiff|subid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LSMG_LSMG.txt",sep="\t")
