...
subdata <- item_data
itemInfo_actmean <- lmer(LANG_rsadiff~LpPHG_actmean+(1+LpPHG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LANG_rsadiff~1+(1+LpPHG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LANG_rsadiff~LpPHG_actmean+(1+LpPHG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LANG_rsadiff~1+(1+LpPHG_rsadiff|subid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LANG_LpPHG.txt",sep="\t")
