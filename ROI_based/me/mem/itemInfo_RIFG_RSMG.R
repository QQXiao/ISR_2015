...
subdata <- item_data
itemInfo_actmean <- lmer(RIFG_rsadiff~RSMG_actmean+(1+RSMG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RIFG_rsadiff~1+(1+RSMG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RIFG_rsadiff~RSMG_actmean+(1+RSMG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RIFG_rsadiff~1+(1+RSMG_rsadiff|subid),REML=FALSE,data=subdata)
