...
itemInfo_actmean <- lmer(dLOC_rsadiff~HIP_actmean+(1+HIP_actmean|subid)+(1+HIP_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~1+(1+HIP_actmean|subid)+(1+HIP_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(dLOC_rsadiff~HIP_actrep+(1+HIP_actrep|subid)+(1+HIP_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(dLOC_rsadiff~1+(1+HIP_actrep|subid)+(1+HIP_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~HIP_rsadiff+(1+HIP_rsadiff|subid)+(1+HIP_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~1+(1+HIP_rsadiff|subid)+(1+HIP_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsadiff~HIP_rsaD+(1+HIP_rsaD|subid)+(1+HIP_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsadiff~1+(1+HIP_rsaD|subid)+(1+HIP_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(dLOC_rsaD~HIP_actmean+(1+HIP_actmean|subid)+(1+HIP_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~1+(1+HIP_actmean|subid)+(1+HIP_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(dLOC_rsaD~HIP_actrep+(1+HIP_actrep|subid)+(1+HIP_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(dLOC_rsaD~1+(1+HIP_actrep|subid)+(1+HIP_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(dLOC_rsaD~HIP_rsadiff+(1+HIP_rsadiff|subid)+(1+HIP_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(dLOC_rsaD~1+(1+HIP_rsadiff|subid)+(1+HIP_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(dLOC_rsaD~HIP_rsaD+(1+HIP_rsaD|subid)+(1+HIP_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(dLOC_rsaD~1+(1+HIP_rsaD|subid)+(1+HIP_rsaD|pid),REML=FALSE,data=subdata)
