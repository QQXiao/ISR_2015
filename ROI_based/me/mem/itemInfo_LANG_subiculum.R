...
subdata <- item_data
itemInfo_actmean <- lmer(LANG_rsadiff~subiculum_actmean+(1+subiculum_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LANG_rsadiff~1+(1+subiculum_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LANG_rsadiff~subiculum_actmean+(1+subiculum_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LANG_rsadiff~1+(1+subiculum_rsadiff|subid),REML=FALSE,data=subdata)
