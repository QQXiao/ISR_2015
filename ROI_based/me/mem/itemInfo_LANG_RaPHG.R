...
subdata <- item_data
itemInfo_actmean <- lmer(LANG_rsadiff~RaPHG_actmean+(1+RaPHG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LANG_rsadiff~1+(1+RaPHG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LANG_rsadiff~RaPHG_actmean+(1+RaPHG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LANG_rsadiff~1+(1+RaPHG_rsadiff|subid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LANG_RaPHG.txt",sep="\t")
