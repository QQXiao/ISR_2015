...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~DG_actmean+DG_rsadiff+(1+DG_actmean+DG_rsadiff|subid)+(1+DG_actmean+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~DG_rsadiff+(1+DG_actmean+DG_rsadiff|subid)+(1+DG_actmean+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~DG_rsadiff+DG_actmean+(1+DG_rsadiff+DG_actmean|subid)+(1+DG_rsadiff+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~DG_actmean+(1+DG_rsadiff+DG_actmean|subid)+(1+DG_rsadiff+DG_actmean|pid),REML=FALSE,data=subdata)
