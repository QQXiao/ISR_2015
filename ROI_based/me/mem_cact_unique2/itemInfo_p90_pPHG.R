...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~pPHG_actmean+pPHG_rsadiff+(1+pPHG_actmean+pPHG_rsadiff|subid)+(1+pPHG_actmean+pPHG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~pPHG_rsadiff+(1+pPHG_actmean+pPHG_rsadiff|subid)+(1+pPHG_actmean+pPHG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~pPHG_rsadiff+pPHG_actmean+(1+pPHG_rsadiff+pPHG_actmean|subid)+(1+pPHG_rsadiff+pPHG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~pPHG_actmean+(1+pPHG_rsadiff+pPHG_actmean|subid)+(1+pPHG_rsadiff+pPHG_actmean|pid),REML=FALSE,data=subdata)
