...
itemInfo_actmean <- lmer(p95_rsadiff~aPHG_actmean+aPHG_rsadiff+(1+aPHG_actmean+aPHG_rsadiff|subid)+(1+aPHG_actmean+aPHG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~aPHG_rsadiff+(1+aPHG_actmean+aPHG_rsadiff|subid)+(1+aPHG_actmean+aPHG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~aPHG_rsadiff+aPHG_actmean+(1+aPHG_rsadiff+aPHG_actmean|subid)+(1+aPHG_rsadiff+aPHG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~aPHG_actmean+(1+aPHG_rsadiff+aPHG_actmean|subid)+(1+aPHG_rsadiff+aPHG_actmean|pid),REML=FALSE,data=subdata)
