...
itemInfo_actmean <- lmer(p95_rsadiff~CA1_actmean+CA1_rsadiff+(1+CA1_actmean+CA1_rsadiff|subid)+(1+CA1_actmean+CA1_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~CA1_rsadiff+(1+CA1_actmean+CA1_rsadiff|subid)+(1+CA1_actmean+CA1_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~CA1_rsadiff+CA1_actmean+(1+CA1_rsadiff+CA1_actmean|subid)+(1+CA1_rsadiff+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~CA1_actmean+(1+CA1_rsadiff+CA1_actmean|subid)+(1+CA1_rsadiff+CA1_actmean|pid),REML=FALSE,data=subdata)
