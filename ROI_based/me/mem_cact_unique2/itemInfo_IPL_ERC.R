...
subdata <- item_data
itemInfo_actmean <- lmer(IPL_rsadiff~ERC_actmean+ERC_rsadiff+(1+ERC_actmean+ERC_rsadiff|subid)+(1+ERC_actmean+ERC_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~ERC_rsadiff+(1+ERC_actmean+ERC_rsadiff|subid)+(1+ERC_actmean+ERC_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~ERC_rsadiff+ERC_actmean+(1+ERC_rsadiff+ERC_actmean|subid)+(1+ERC_rsadiff+ERC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~ERC_actmean+(1+ERC_rsadiff+ERC_actmean|subid)+(1+ERC_rsadiff+ERC_actmean|pid),REML=FALSE,data=subdata)
