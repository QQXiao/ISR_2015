...
itemInfo_actmean <- lmer(p95_rsadiff~IFG_actmean+IFG_rsadiff+(1+IFG_actmean+IFG_rsadiff|subid)+(1+IFG_actmean+IFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~IFG_rsadiff+(1+IFG_actmean+IFG_rsadiff|subid)+(1+IFG_actmean+IFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~IFG_rsadiff+IFG_actmean+(1+IFG_rsadiff+IFG_actmean|subid)+(1+IFG_rsadiff+IFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~IFG_actmean+(1+IFG_rsadiff+IFG_actmean|subid)+(1+IFG_rsadiff+IFG_actmean|pid),REML=FALSE,data=subdata)
