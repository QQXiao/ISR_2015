...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~CA3_actmean+CA3_rsadiff+(1+CA3_actmean+CA3_rsadiff|subid)+(1+CA3_actmean+CA3_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~CA3_rsadiff+(1+CA3_actmean+CA3_rsadiff|subid)+(1+CA3_actmean+CA3_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~CA3_rsadiff+CA3_actmean+(1+CA3_rsadiff+CA3_actmean|subid)+(1+CA3_rsadiff+CA3_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~CA3_actmean+(1+CA3_rsadiff+CA3_actmean|subid)+(1+CA3_rsadiff+CA3_actmean|pid),REML=FALSE,data=subdata)
