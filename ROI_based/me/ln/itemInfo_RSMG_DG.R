...
subdata <- item_data
itemInfo_actmean <- lmer(RSMG_rsadiff~DG_actmean+(1+DG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RSMG_rsadiff~1+(1+DG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RSMG_rsadiff~DG_actmean+(1+DG_rsadiff|subid),REML=FALSE,data=subdata)
