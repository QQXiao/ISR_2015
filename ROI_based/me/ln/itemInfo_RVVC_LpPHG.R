...
subdata <- item_data
itemInfo_actmean <- lmer(RVVC_rsadiff~LpPHG_actmean+(1+LpPHG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RVVC_rsadiff~1+(1+LpPHG_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RVVC_rsadiff~LpPHG_actmean+(1+LpPHG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RVVC_rsadiff~1+(1+LpPHG_rsadiff|subid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_RVVC_LpPHG.txt",sep="\t")
