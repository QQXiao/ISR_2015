...
itemInfo_actmean <- lmer(p95_rsadiff~SMG_actmean+(1+SMG_actmean|subid)+(1+SMG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~1+(1+SMG_actmean|subid)+(1+SMG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(p95_rsadiff~SMG_actrep+(1+SMG_actrep|subid)+(1+SMG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(p95_rsadiff~1+(1+SMG_actrep|subid)+(1+SMG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~SMG_rsadiff+(1+SMG_rsadiff|subid)+(1+SMG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~1+(1+SMG_rsadiff|subid)+(1+SMG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(p95_rsadiff~SMG_rsaD+(1+SMG_rsaD|subid)+(1+SMG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(p95_rsadiff~1+(1+SMG_rsaD|subid)+(1+SMG_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(p95_rsaD~SMG_actmean+(1+SMG_actmean|subid)+(1+SMG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(p95_rsaD~1+(1+SMG_actmean|subid)+(1+SMG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(p95_rsaD~SMG_actrep+(1+SMG_actrep|subid)+(1+SMG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(p95_rsaD~1+(1+SMG_actrep|subid)+(1+SMG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(p95_rsaD~SMG_rsadiff+(1+SMG_rsadiff|subid)+(1+SMG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(p95_rsaD~1+(1+SMG_rsadiff|subid)+(1+SMG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(p95_rsaD~SMG_rsaD+(1+SMG_rsaD|subid)+(1+SMG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(p95_rsaD~1+(1+SMG_rsaD|subid)+(1+SMG_rsaD|pid),REML=FALSE,data=subdata)
