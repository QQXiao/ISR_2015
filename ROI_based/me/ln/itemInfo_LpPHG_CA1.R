...
subdata <- item_data
itemInfo_actmean <- lmer(LpPHG_rsadiff~CA1_actmean+(1+CA1_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LpPHG_rsadiff~1+(1+CA1_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LpPHG_rsadiff~CA1_actmean+(1+CA1_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LpPHG_rsadiff~1+(1+CA1_rsadiff|subid),REML=FALSE,data=subdata)
