...
subdata <- item_data
itemInfo_actmean <- lmer(ERC_rsadiff~subiculum_actmean+(1+subiculum_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(ERC_rsadiff~1+(1+subiculum_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(ERC_rsadiff~subiculum_actmean+(1+subiculum_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(ERC_rsadiff~1+(1+subiculum_rsadiff|subid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_ERC_subiculum.txt",sep="\t")
