...
subdata <- item_data
itemInfo_actmean <- lmer(RpPHG_rsadiff~PRC_actmean+(1+PRC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RpPHG_rsadiff~1+(1+PRC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RpPHG_rsadiff~PRC_actmean+(1+PRC_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RpPHG_rsadiff~1+(1+PRC_rsadiff|subid),REML=FALSE,data=subdata)
