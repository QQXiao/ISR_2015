...
subdata <- item_data
itemInfo_actmean <- lmer(RSMG_rsadiff~PRC_actmean+(1+PRC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RSMG_rsadiff~1+(1+PRC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RSMG_rsadiff~PRC_actmean+(1+PRC_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RSMG_rsadiff~1+(1+PRC_rsadiff|subid),REML=FALSE,data=subdata)
