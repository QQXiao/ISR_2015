...
r.itemInfo[3,1]=mainEffect.itemInfo_rsaD[2,6]
r.itemInfo[3,2]=mainEffect.itemInfo_rsaD[2,7]
r.itemInfo[3,3]=mainEffect.itemInfo_rsaD[2,8]
r.itemInfo[3,4]=fixef(itemInfo_rsaD)[2];
