...
subdata <- item_data
itemInfo_actmean <- lmer(RANG_rsadiff~RIFG_actmean+(1+RIFG_actmean|subid)+(1+RIFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RANG_rsadiff~1+(1+RIFG_actmean|subid)+(1+RIFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RANG_rsadiff~RIFG_actmean+(1+RIFG_rsadiff|subid)+(1+RIFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RANG_rsadiff~1+(1+RIFG_rsadiff|subid)+(1+RIFG_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_RANG_RIFG.txt",sep="\t")
