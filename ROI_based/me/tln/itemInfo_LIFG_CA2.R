...
subdata <- item_data
itemInfo_actmean <- lmer(LIFG_rsadiff~CA2_actmean+(1+CA2_actmean|subid)+(1+CA2_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LIFG_rsadiff~1+(1+CA2_actmean|subid)+(1+CA2_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LIFG_rsadiff~CA2_actmean+(1+CA2_rsadiff|subid)+(1+CA2_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LIFG_rsadiff~1+(1+CA2_rsadiff|subid)+(1+CA2_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LIFG_CA2.txt",sep="\t")
