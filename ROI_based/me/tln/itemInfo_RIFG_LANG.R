...
subdata <- item_data
itemInfo_actmean <- lmer(RIFG_rsadiff~LANG_actmean+(1+LANG_actmean|subid)+(1+LANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RIFG_rsadiff~1+(1+LANG_actmean|subid)+(1+LANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RIFG_rsadiff~LANG_actmean+(1+LANG_rsadiff|subid)+(1+LANG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RIFG_rsadiff~1+(1+LANG_rsadiff|subid)+(1+LANG_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_RIFG_LANG.txt",sep="\t")
