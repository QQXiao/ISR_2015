...
subdata <- item_data
itemInfo_actmean <- lmer(LSMG_rsadiff~RIFG_actmean+(1+RIFG_actmean|subid)+(1+RIFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LSMG_rsadiff~1+(1+RIFG_actmean|subid)+(1+RIFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LSMG_rsadiff~RIFG_actmean+(1+RIFG_rsadiff|subid)+(1+RIFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LSMG_rsadiff~1+(1+RIFG_rsadiff|subid)+(1+RIFG_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LSMG_RIFG.txt",sep="\t")
