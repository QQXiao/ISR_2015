...
subdata <- item_data
itemInfo_actmean <- lmer(p97_rsadiff~CA1_actmean+(1+CA1_actmean|subid)+(1+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p97_rsadiff~1+(1+CA1_actmean|subid)+(1+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(p97_rsadiff~CA1_actmean+(1+CA1_rsadiff|subid)+(1+CA1_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(p97_rsadiff~1+(1+CA1_rsadiff|subid)+(1+CA1_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_p97_CA1.txt",sep="\t")
