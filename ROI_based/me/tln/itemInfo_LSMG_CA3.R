...
subdata <- item_data
itemInfo_actmean <- lmer(LSMG_rsadiff~CA3_actmean+(1+CA3_actmean|subid)+(1+CA3_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LSMG_rsadiff~1+(1+CA3_actmean|subid)+(1+CA3_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LSMG_rsadiff~CA3_actmean+(1+CA3_rsadiff|subid)+(1+CA3_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LSMG_rsadiff~1+(1+CA3_rsadiff|subid)+(1+CA3_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LSMG_CA3.txt",sep="\t")
