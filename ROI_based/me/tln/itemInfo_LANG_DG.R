...
subdata <- item_data
itemInfo_actmean <- lmer(LANG_rsadiff~DG_actmean+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LANG_rsadiff~1+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LANG_rsadiff~DG_actmean+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LANG_rsadiff~1+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
