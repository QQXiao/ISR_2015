...
subdata <- item_data
itemInfo_actmean <- lmer(LVVC_rsadiff~LANG_actmean+(1+LANG_actmean|subid)+(1+LANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LVVC_rsadiff~1+(1+LANG_actmean|subid)+(1+LANG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LVVC_rsadiff~LANG_actmean+(1+LANG_rsadiff|subid)+(1+LANG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LVVC_rsadiff~1+(1+LANG_rsadiff|subid)+(1+LANG_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_LVVC_LANG.txt",sep="\t")
