...
subdata <- item_data
itemInfo_actmean <- lmer(RIFG_rsadiff~subiculum_actmean+(1+subiculum_actmean|subid)+(1+subiculum_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RIFG_rsadiff~1+(1+subiculum_actmean|subid)+(1+subiculum_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RIFG_rsadiff~subiculum_actmean+(1+subiculum_rsadiff|subid)+(1+subiculum_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RIFG_rsadiff~1+(1+subiculum_rsadiff|subid)+(1+subiculum_rsadiff|pid),REML=FALSE,data=subdata)
