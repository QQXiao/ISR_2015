...
subdata <- item_data
itemInfo_actmean <- lmer(RSMG_rsadiff~CA1_actmean+(1+CA1_actmean|subid)+(1+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RSMG_rsadiff~1+(1+CA1_actmean|subid)+(1+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RSMG_rsadiff~CA1_actmean+(1+CA1_rsadiff|subid)+(1+CA1_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RSMG_rsadiff~1+(1+CA1_rsadiff|subid)+(1+CA1_rsadiff|pid),REML=FALSE,data=subdata)
