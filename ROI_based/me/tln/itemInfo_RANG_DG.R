...
subdata <- item_data
itemInfo_actmean <- lmer(RANG_rsadiff~DG_actmean+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RANG_rsadiff~1+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RANG_rsadiff~DG_actmean+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RANG_rsadiff~1+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
