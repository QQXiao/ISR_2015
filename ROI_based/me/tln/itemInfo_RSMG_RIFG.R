...
subdata <- item_data
itemInfo_actmean <- lmer(RSMG_rsadiff~RIFG_actmean+(1+RIFG_actmean|subid)+(1+RIFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RSMG_rsadiff~1+(1+RIFG_actmean|subid)+(1+RIFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RSMG_rsadiff~RIFG_actmean+(1+RIFG_rsadiff|subid)+(1+RIFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RSMG_rsadiff~1+(1+RIFG_rsadiff|subid)+(1+RIFG_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_RSMG_RIFG.txt",sep="\t")
