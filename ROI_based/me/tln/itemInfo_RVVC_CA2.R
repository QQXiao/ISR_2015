...
subdata <- item_data
itemInfo_actmean <- lmer(RVVC_rsadiff~CA2_actmean+(1+CA2_actmean|subid)+(1+CA2_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RVVC_rsadiff~1+(1+CA2_actmean|subid)+(1+CA2_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RVVC_rsadiff~CA2_actmean+(1+CA2_rsadiff|subid)+(1+CA2_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RVVC_rsadiff~1+(1+CA2_rsadiff|subid)+(1+CA2_rsadiff|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfso_RVVC_CA2.txt",sep="\t")
