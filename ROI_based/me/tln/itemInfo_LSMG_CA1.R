...
subdata <- item_data
itemInfo_actmean <- lmer(LSMG_rsadiff~CA1_actmean+(1+CA1_actmean|subid)+(1+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LSMG_rsadiff~1+(1+CA1_actmean|subid)+(1+CA1_actmean|pid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LSMG_rsadiff~CA1_actmean+(1+CA1_rsadiff|subid)+(1+CA1_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LSMG_rsadiff~1+(1+CA1_rsadiff|subid)+(1+CA1_rsadiff|pid),REML=FALSE,data=subdata)
