...
itemInfo_actmean <- lmer(p90_rsadiff~CA1_actmean+p90_actmean+(1+CA1_actmean+p90_actmean|subid)+(1+CA1_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~p90_actmean+(1+CA1_actmean+p90_actmean|subid)+(1+CA1_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(p90_rsadiff~CA1_actrep+p90_actmean+(1+CA1_actrep+p90_actmean|subid)+(1+CA1_actrep+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(p90_rsadiff~p90_actmean+(1+CA1_actrep+p90_actmean|subid)+(1+CA1_actrep+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~CA1_rsadiff+p90_actmean+(1+CA1_rsadiff+p90_actmean|subid)+(1+CA1_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~p90_actmean+(1+CA1_rsadiff+p90_actmean|subid)+(1+CA1_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
