...
itemInfo_actmean <- lmer(IPL_rsadiff~ERC_actmean+IPL_actmean+(1+ERC_actmean+IPL_actmean|subid)+(1+ERC_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+(1+ERC_actmean+IPL_actmean|subid)+(1+ERC_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(IPL_rsadiff~ERC_actrep+IPL_actmean+(1+ERC_actrep+IPL_actmean|subid)+(1+ERC_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(IPL_rsadiff~IPL_actmean+(1+ERC_actrep+IPL_actmean|subid)+(1+ERC_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~ERC_rsadiff+IPL_actmean+(1+ERC_rsadiff+IPL_actmean|subid)+(1+ERC_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~IPL_actmean+(1+ERC_rsadiff+IPL_actmean|subid)+(1+ERC_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_IPL_ERC.txt",sep="\t")
