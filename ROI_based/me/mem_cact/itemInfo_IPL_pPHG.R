...
subdata <- item_data
subdata$pPHG_actrep <- item_data$pPHG_act1-item_data$pPHG_act2
itemInfo_actmean <- lmer(IPL_rsadiff~pPHG_actmean+IPL_actmean+(1+pPHG_actmean+IPL_actmean|subid)+(1+pPHG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+(1+pPHG_actmean+IPL_actmean|subid)+(1+pPHG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(IPL_rsadiff~pPHG_actrep+IPL_actmean+(1+pPHG_actrep+IPL_actmean|subid)+(1+pPHG_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(IPL_rsadiff~IPL_actmean+(1+pPHG_actrep+IPL_actmean|subid)+(1+pPHG_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~pPHG_rsadiff+IPL_actmean+(1+pPHG_rsadiff+IPL_actmean|subid)+(1+pPHG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~IPL_actmean+(1+pPHG_rsadiff+IPL_actmean|subid)+(1+pPHG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_IPL_pPHG.txt",sep="\t")
