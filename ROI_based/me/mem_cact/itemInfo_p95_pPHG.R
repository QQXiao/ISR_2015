...
itemInfo_actmean <- lmer(p95_rsadiff~pPHG_actmean+p95_actmean+(1+pPHG_actmean+p95_actmean|subid)+(1+pPHG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+(1+pPHG_actmean+p95_actmean|subid)+(1+pPHG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(p95_rsadiff~pPHG_actrep+p95_actmean+(1+pPHG_actrep+p95_actmean|subid)+(1+pPHG_actrep+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(p95_rsadiff~p95_actmean+(1+pPHG_actrep+p95_actmean|subid)+(1+pPHG_actrep+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~pPHG_rsadiff+p95_actmean+(1+pPHG_rsadiff+p95_actmean|subid)+(1+pPHG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~p95_actmean+(1+pPHG_rsadiff+p95_actmean|subid)+(1+pPHG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_p95_pPHG.txt",sep="\t")
