...
subdata <- item_data
subdata$aPHG_actrep <- item_data$aPHG_act1-item_data$aPHG_act2
itemInfo_actmean <- lmer(IPL_rsadiff~aPHG_actmean+IPL_actmean+(1+aPHG_actmean+IPL_actmean|subid)+(1+aPHG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+(1+aPHG_actmean+IPL_actmean|subid)+(1+aPHG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(IPL_rsadiff~aPHG_actrep+IPL_actmean+(1+aPHG_actrep+IPL_actmean|subid)+(1+aPHG_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(IPL_rsadiff~IPL_actmean+(1+aPHG_actrep+IPL_actmean|subid)+(1+aPHG_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~aPHG_rsadiff+IPL_actmean+(1+aPHG_rsadiff+IPL_actmean|subid)+(1+aPHG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~IPL_actmean+(1+aPHG_rsadiff+IPL_actmean|subid)+(1+aPHG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_IPL_aPHG.txt",sep="\t")
