...
itemInfo_actmean <- lmer(IPL_rsadiff~DG_actmean+IPL_actmean+(1+DG_actmean+IPL_actmean|subid)+(1+DG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+(1+DG_actmean+IPL_actmean|subid)+(1+DG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(IPL_rsadiff~DG_actrep+IPL_actmean+(1+DG_actrep+IPL_actmean|subid)+(1+DG_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(IPL_rsadiff~IPL_actmean+(1+DG_actrep+IPL_actmean|subid)+(1+DG_actrep+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~DG_rsadiff+IPL_actmean+(1+DG_rsadiff+IPL_actmean|subid)+(1+DG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~IPL_actmean+(1+DG_rsadiff+IPL_actmean|subid)+(1+DG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_IPL_DG.txt",sep="\t")
