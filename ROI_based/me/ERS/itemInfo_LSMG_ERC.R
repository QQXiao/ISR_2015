...
subdata <- item_data
itemInfo_actmean <- lmer(LSMG_rsadiff~ERC_actmean+(1+ERC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LSMG_rsadiff~1+(1+ERC_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LSMG_rsadiff~ERC_actmean+(1+ERC_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LSMG_rsadiff~1+(1+ERC_rsadiff|subid),REML=FALSE,data=subdata)
