...
subdata <- item_data
itemInfo_actmean <- lmer(LVVC_rsadiff~CA1_ln_actmean+(1+CA1_ln_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LVVC_rsadiff~1+(1+CA1_ln_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LVVC_rsadiff~CA1_ln_actmean+(1+CA1_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LVVC_rsadiff~1+(1+CA1_rsadiff|subid),REML=FALSE,data=subdata)
