...
subdata <- item_data
itemInfo_actmean <- lmer(RIFG_rsadiff~DG_ln_actmean+(1+DG_ln_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(RIFG_rsadiff~1+(1+DG_ln_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(RIFG_rsadiff~DG_ln_actmean+(1+DG_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(RIFG_rsadiff~1+(1+DG_rsadiff|subid),REML=FALSE,data=subdata)
