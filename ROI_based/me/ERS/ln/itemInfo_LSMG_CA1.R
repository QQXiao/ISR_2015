...
subdata <- item_data
itemInfo_actmean <- lmer(LSMG_rsadiff~CA1_ln_actmean+(1+CA1_ln_actmean|subid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(LSMG_rsadiff~1+(1+CA1_ln_actmean|subid),REML=FALSE,data=subdata)
itemInfo_di <- lmer(LSMG_rsadiff~CA1_ln_actmean+(1+CA1_rsadiff|subid),REML=FALSE,data=subdata)
itemInfo_di.null <- lmer(LSMG_rsadiff~1+(1+CA1_rsadiff|subid),REML=FALSE,data=subdata)
