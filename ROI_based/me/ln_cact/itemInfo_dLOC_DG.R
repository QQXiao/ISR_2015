...
subdata <- item_data
subdata$DG_actrep <- item_data$DG_act1-item_data$DG_act2
itemInfo_actmean <- lmer(dLOC_rsadiff~DG_actmean+dLOC_actmean+(1+DG_actmean+dLOC_actmean|subid)+(1+DG_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~dLOC_actmean+(1+DG_actmean+dLOC_actmean|subid)+(1+DG_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(dLOC_rsadiff~DG_actrep+dLOC_actmean+(1+DG_actrep+dLOC_actmean|subid)+(1+DG_actrep+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(dLOC_rsadiff~dLOC_actmean+(1+DG_actrep+dLOC_actmean|subid)+(1+DG_actrep+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~DG_rsadiff+dLOC_actmean+(1+DG_rsadiff+dLOC_actmean|subid)+(1+DG_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~dLOC_actmean+(1+DG_rsadiff+dLOC_actmean|subid)+(1+DG_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsadiff~DG_rsaD+dLOC_actmean+(1+DG_rsaD+dLOC_actmean|subid)+(1+DG_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsadiff~dLOC_actmean+(1+DG_rsaD+dLOC_actmean|subid)+(1+DG_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(dLOC_rsaD~DG_actmean+dLOC_actmean+(1+DG_actmean+dLOC_actmean|subid)+(1+DG_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~dLOC_actmean+(1+DG_actmean+dLOC_actmean|subid)+(1+DG_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(dLOC_rsaD~DG_actrep+dLOC_actmean+(1+DG_actrep+dLOC_actmean|subid)+(1+DG_actrep+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(dLOC_rsaD~dLOC_actmean+(1+DG_actrep+dLOC_actmean|subid)+(1+DG_actrep+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(dLOC_rsaD~DG_rsadiff+dLOC_actmean+(1+DG_rsadiff+dLOC_actmean|subid)+(1+DG_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(dLOC_rsaD~dLOC_actmean+(1+DG_rsadiff+dLOC_actmean|subid)+(1+DG_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(dLOC_rsaD~DG_rsaD+dLOC_actmean+(1+DG_rsaD+dLOC_actmean|subid)+(1+DG_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(dLOC_rsaD~dLOC_actmean+(1+DG_rsaD+dLOC_actmean|subid)+(1+DG_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_dLOC_DG.txt",sep="\t")
