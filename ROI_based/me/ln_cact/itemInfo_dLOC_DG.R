...
itemInfo_actmean <- lmer(dLOC_rsadiff~DG_actmean+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~1+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(dLOC_rsadiff~DG_actrep+(1+DG_actrep|subid)+(1+DG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(dLOC_rsadiff~1+(1+DG_actrep|subid)+(1+DG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~DG_rsadiff+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~1+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsadiff~DG_rsaD+(1+DG_rsaD|subid)+(1+DG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsadiff~1+(1+DG_rsaD|subid)+(1+DG_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(dLOC_rsaD~DG_actmean+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~1+(1+DG_actmean|subid)+(1+DG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(dLOC_rsaD~DG_actrep+(1+DG_actrep|subid)+(1+DG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(dLOC_rsaD~1+(1+DG_actrep|subid)+(1+DG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(dLOC_rsaD~DG_rsadiff+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(dLOC_rsaD~1+(1+DG_rsadiff|subid)+(1+DG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(dLOC_rsaD~DG_rsaD+(1+DG_rsaD|subid)+(1+DG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(dLOC_rsaD~1+(1+DG_rsaD|subid)+(1+DG_rsaD|pid),REML=FALSE,data=subdata)
