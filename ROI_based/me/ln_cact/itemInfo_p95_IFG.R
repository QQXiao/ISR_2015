...
itemInfo_actmean <- lmer(p95_rsadiff~IFG_actmean+p95_actmean+(1+IFG_actmean+p95_actmean|subid)+(1+IFG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+(1+IFG_actmean+p95_actmean|subid)+(1+IFG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(p95_rsadiff~IFG_actrep+p95_actmean+(1+IFG_actrep+p95_actmean|subid)+(1+IFG_actrep+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(p95_rsadiff~p95_actmean+(1+IFG_actrep+p95_actmean|subid)+(1+IFG_actrep+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~IFG_rsadiff+p95_actmean+(1+IFG_rsadiff+p95_actmean|subid)+(1+IFG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~p95_actmean+(1+IFG_rsadiff+p95_actmean|subid)+(1+IFG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(p95_rsadiff~IFG_rsaD+p95_actmean+(1+IFG_rsaD+p95_actmean|subid)+(1+IFG_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(p95_rsadiff~p95_actmean+(1+IFG_rsaD+p95_actmean|subid)+(1+IFG_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(p95_rsaD~IFG_actmean+p95_actmean+(1+IFG_actmean+p95_actmean|subid)+(1+IFG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(p95_rsaD~p95_actmean+(1+IFG_actmean+p95_actmean|subid)+(1+IFG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(p95_rsaD~IFG_actrep+p95_actmean+(1+IFG_actrep+p95_actmean|subid)+(1+IFG_actrep+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(p95_rsaD~p95_actmean+(1+IFG_actrep+p95_actmean|subid)+(1+IFG_actrep+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(p95_rsaD~IFG_rsadiff+p95_actmean+(1+IFG_rsadiff+p95_actmean|subid)+(1+IFG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(p95_rsaD~p95_actmean+(1+IFG_rsadiff+p95_actmean|subid)+(1+IFG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(p95_rsaD~IFG_rsaD+p95_actmean+(1+IFG_rsaD+p95_actmean|subid)+(1+IFG_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(p95_rsaD~p95_actmean+(1+IFG_rsaD+p95_actmean|subid)+(1+IFG_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_p95_IFG.txt",sep="\t")
