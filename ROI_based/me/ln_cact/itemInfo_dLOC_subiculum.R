...
itemInfo_actmean <- lmer(dLOC_rsadiff~subiculum_actmean+(1+subiculum_actmean|subid)+(1+subiculum_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~1+(1+subiculum_actmean|subid)+(1+subiculum_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(dLOC_rsadiff~subiculum_actrep+(1+subiculum_actrep|subid)+(1+subiculum_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(dLOC_rsadiff~1+(1+subiculum_actrep|subid)+(1+subiculum_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~subiculum_rsadiff+(1+subiculum_rsadiff|subid)+(1+subiculum_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~1+(1+subiculum_rsadiff|subid)+(1+subiculum_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsadiff~subiculum_rsaD+(1+subiculum_rsaD|subid)+(1+subiculum_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsadiff~1+(1+subiculum_rsaD|subid)+(1+subiculum_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(dLOC_rsaD~subiculum_actmean+(1+subiculum_actmean|subid)+(1+subiculum_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~1+(1+subiculum_actmean|subid)+(1+subiculum_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(dLOC_rsaD~subiculum_actrep+(1+subiculum_actrep|subid)+(1+subiculum_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(dLOC_rsaD~1+(1+subiculum_actrep|subid)+(1+subiculum_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(dLOC_rsaD~subiculum_rsadiff+(1+subiculum_rsadiff|subid)+(1+subiculum_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(dLOC_rsaD~1+(1+subiculum_rsadiff|subid)+(1+subiculum_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(dLOC_rsaD~subiculum_rsaD+(1+subiculum_rsaD|subid)+(1+subiculum_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(dLOC_rsaD~1+(1+subiculum_rsaD|subid)+(1+subiculum_rsaD|pid),REML=FALSE,data=subdata)
