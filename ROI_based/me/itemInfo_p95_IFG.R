...
itemInfo_actmean <- lmer(p95_rsadiff~IFG_actmean+(1+IFG_actmean|subid)+(1+IFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~1+(1+IFG_actmean|subid)+(1+IFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(p95_rsadiff~IFG_actrep+(1+IFG_actrep|subid)+(1+IFG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(p95_rsadiff~1+(1+IFG_actrep|subid)+(1+IFG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~IFG_rsadiff+(1+IFG_rsadiff|subid)+(1+IFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~1+(1+IFG_rsadiff|subid)+(1+IFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(p95_rsadiff~IFG_rsaD+(1+IFG_rsaD|subid)+(1+IFG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(p95_rsadiff~1+(1+IFG_rsaD|subid)+(1+IFG_rsaD|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(p95_rsaD~IFG_actmean+(1+IFG_actmean|subid)+(1+IFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(p95_rsaD~1+(1+IFG_actmean|subid)+(1+IFG_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(p95_rsaD~IFG_actrep+(1+IFG_actrep|subid)+(1+IFG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(p95_rsaD~1+(1+IFG_actrep|subid)+(1+IFG_actrep|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(p95_rsaD~IFG_rsadiff+(1+IFG_rsadiff|subid)+(1+IFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(p95_rsaD~1+(1+IFG_rsadiff|subid)+(1+IFG_rsadiff|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(p95_rsaD~IFG_rsaD+(1+IFG_rsaD|subid)+(1+IFG_rsaD|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(p95_rsaD~1+(1+IFG_rsaD|subid)+(1+IFG_rsaD|pid),REML=FALSE,data=subdata)
