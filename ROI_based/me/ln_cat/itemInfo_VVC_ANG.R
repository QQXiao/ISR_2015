...
itemInfo_actmean <- lmer(VVC_rsadiff~ANG_actmean+VVC_actmean+(1+ANG_actmean+VVC_actmean|subid)+(1+ANG_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(VVC_rsadiff~VVC_actmean+(1+ANG_actmean+VVC_actmean|subid)+(1+ANG_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep <- lmer(VVC_rsadiff~ANG_actrep+VVC_actmean+(1+ANG_actrep+VVC_actmean|subid)+(1+ANG_actrep+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrep.null <- lmer(VVC_rsadiff~VVC_actmean+(1+ANG_actrep+VVC_actmean|subid)+(1+ANG_actrep+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(VVC_rsadiff~ANG_rsadiff+VVC_actmean+(1+ANG_rsadiff+VVC_actmean|subid)+(1+ANG_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(VVC_rsadiff~VVC_actmean+(1+ANG_rsadiff+VVC_actmean|subid)+(1+ANG_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(VVC_rsadiff~ANG_rsaD+VVC_actmean+(1+ANG_rsaD+VVC_actmean|subid)+(1+ANG_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(VVC_rsadiff~VVC_actmean+(1+ANG_rsaD+VVC_actmean|subid)+(1+ANG_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)

itemInfo_actmeanD <- lmer(VVC_rsaD~ANG_actmean+VVC_actmean+(1+ANG_actmean+VVC_actmean|subid)+(1+ANG_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(VVC_rsaD~VVC_actmean+(1+ANG_actmean+VVC_actmean|subid)+(1+ANG_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD <- lmer(VVC_rsaD~ANG_actrep+VVC_actmean+(1+ANG_actrep+VVC_actmean|subid)+(1+ANG_actrep+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actrepD.null <- lmer(VVC_rsaD~VVC_actmean+(1+ANG_actrep+VVC_actmean|subid)+(1+ANG_actrep+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD <- lmer(VVC_rsaD~ANG_rsadiff+VVC_actmean+(1+ANG_rsadiff+VVC_actmean|subid)+(1+ANG_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiffD.null <- lmer(VVC_rsaD~VVC_actmean+(1+ANG_rsadiff+VVC_actmean|subid)+(1+ANG_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD <- lmer(VVC_rsaD~ANG_rsaD+VVC_actmean+(1+ANG_rsaD+VVC_actmean|subid)+(1+ANG_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaDD.null <- lmer(VVC_rsaD~VVC_actmean+(1+ANG_rsaD+VVC_actmean|subid)+(1+ANG_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_VVC_ANG.txt",sep="\t")
