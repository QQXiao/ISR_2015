...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+CA2_rsadiff+(1+CA2_actmean+CA2_rsadiff+p95_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
