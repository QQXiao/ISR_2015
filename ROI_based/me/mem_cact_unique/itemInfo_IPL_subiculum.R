...
subdata <- item_data
itemInfo_actmean <- lmer(IPL_rsadiff~subiculum_actmean+subiculum_rsadiff+IPL_actmean+(1+subiculum_actmean+subiculum_rsadiff+IPL_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+subiculum_rsadiff+(1+subiculum_actmean+subiculum_rsadiff+IPL_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~subiculum_rsadiff+subiculum_actmean+IPL_actmean+(1+subiculum_rsadiff+subiculum_actmean+IPL_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~subiculum_actmean+IPL_actmean+(1+subiculum_rsadiff+subiculum_actmean+IPL_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
