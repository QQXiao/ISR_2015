...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+IFG_rsadiff+(1+IFG_actmean+IFG_rsadiff+p95_actmean|subid)+(1+IFG_actmean+IFG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
