...
subdata <- item_data
itemInfo_actmean <- lmer(p95_rsadiff~pPHG_actmean+pPHG_rsadiff+p95_actmean+(1+pPHG_actmean+pPHG_rsadiff+p95_actmean|subid)+(1+pPHG_actmean+pPHG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+pPHG_rsadiff+(1+pPHG_actmean+pPHG_rsadiff+p95_actmean|subid)+(1+pPHG_actmean+pPHG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~pPHG_rsadiff+pPHG_actmean+p95_actmean+(1+pPHG_rsadiff+pPHG_actmean+p95_actmean|subid)+(1+pPHG_rsadiff+pPHG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~pPHG_actmean+p95_actmean+(1+pPHG_rsadiff+pPHG_actmean+p95_actmean|subid)+(1+pPHG_rsadiff+pPHG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
