...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+CA1_rsadiff+(1+CA1_actmean+CA1_rsadiff+p95_actmean|subid)+(1+CA1_actmean+CA1_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
