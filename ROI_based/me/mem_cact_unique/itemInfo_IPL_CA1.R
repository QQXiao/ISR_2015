...
subdata <- item_data
itemInfo_actmean <- lmer(IPL_rsadiff~CA1_actmean+CA1_rsadiff+IPL_actmean+(1+CA1_actmean+CA1_rsadiff+IPL_actmean|subid)+(1+CA1_actmean+CA1_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+CA1_rsadiff+(1+CA1_actmean+CA1_rsadiff+IPL_actmean|subid)+(1+CA1_actmean+CA1_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~CA1_rsadiff+CA1_actmean+IPL_actmean+(1+CA1_rsadiff+CA1_actmean+IPL_actmean|subid)+(1+CA1_rsadiff+CA1_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~CA1_actmean+IPL_actmean+(1+CA1_rsadiff+CA1_actmean+IPL_actmean|subid)+(1+CA1_rsadiff+CA1_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
