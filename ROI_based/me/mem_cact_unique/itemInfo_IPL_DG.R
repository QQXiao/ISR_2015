...
subdata <- item_data
itemInfo_actmean <- lmer(IPL_rsadiff~DG_actmean+DG_rsadiff+IPL_actmean+(1+DG_actmean+DG_rsadiff+IPL_actmean|subid)+(1+DG_actmean+DG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+DG_rsadiff+(1+DG_actmean+DG_rsadiff+IPL_actmean|subid)+(1+DG_actmean+DG_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~DG_rsadiff+DG_actmean+IPL_actmean+(1+DG_rsadiff+DG_actmean+IPL_actmean|subid)+(1+DG_rsadiff+DG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~DG_actmean+IPL_actmean+(1+DG_rsadiff+DG_actmean+IPL_actmean|subid)+(1+DG_rsadiff+DG_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
