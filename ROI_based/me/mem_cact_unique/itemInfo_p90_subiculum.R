...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~subiculum_actmean+subiculum_rsadiff+p90_actmean+(1+subiculum_actmean+subiculum_rsadiff+p90_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~p90_actmean+subiculum_rsadiff+(1+subiculum_actmean+subiculum_rsadiff+p90_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~subiculum_rsadiff+subiculum_actmean+p90_actmean+(1+subiculum_rsadiff+subiculum_actmean+p90_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~subiculum_actmean+p90_actmean+(1+subiculum_rsadiff+subiculum_actmean+p90_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
