...
subdata <- item_data
itemInfo_actmean <- lmer(p95_rsadiff~aPHG_actmean+aPHG_rsadiff+p95_actmean+(1+aPHG_actmean+aPHG_rsadiff+p95_actmean|subid)+(1+aPHG_actmean+aPHG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+aPHG_rsadiff+(1+aPHG_actmean+aPHG_rsadiff+p95_actmean|subid)+(1+aPHG_actmean+aPHG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~aPHG_rsadiff+aPHG_actmean+p95_actmean+(1+aPHG_rsadiff+aPHG_actmean+p95_actmean|subid)+(1+aPHG_rsadiff+aPHG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~aPHG_actmean+p95_actmean+(1+aPHG_rsadiff+aPHG_actmean+p95_actmean|subid)+(1+aPHG_rsadiff+aPHG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
