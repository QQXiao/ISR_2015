...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~aPHG_actmean+aPHG_rsadiff+p90_actmean+(1+aPHG_actmean+aPHG_rsadiff+p90_actmean|subid)+(1+aPHG_actmean+aPHG_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~p90_actmean+aPHG_rsadiff+(1+aPHG_actmean+aPHG_rsadiff+p90_actmean|subid)+(1+aPHG_actmean+aPHG_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~aPHG_rsadiff+aPHG_actmean+p90_actmean+(1+aPHG_rsadiff+aPHG_actmean+p90_actmean|subid)+(1+aPHG_rsadiff+aPHG_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~aPHG_actmean+p90_actmean+(1+aPHG_rsadiff+aPHG_actmean+p90_actmean|subid)+(1+aPHG_rsadiff+aPHG_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
