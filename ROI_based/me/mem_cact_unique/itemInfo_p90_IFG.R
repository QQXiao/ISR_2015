...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~IFG_actmean+IFG_rsadiff+p90_actmean+(1+IFG_actmean+IFG_rsadiff+p90_actmean|subid)+(1+IFG_actmean+IFG_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~p90_actmean+IFG_rsadiff+(1+IFG_actmean+IFG_rsadiff+p90_actmean|subid)+(1+IFG_actmean+IFG_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~IFG_rsadiff+IFG_actmean+p90_actmean+(1+IFG_rsadiff+IFG_actmean+p90_actmean|subid)+(1+IFG_rsadiff+IFG_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~IFG_actmean+p90_actmean+(1+IFG_rsadiff+IFG_actmean+p90_actmean|subid)+(1+IFG_rsadiff+IFG_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
