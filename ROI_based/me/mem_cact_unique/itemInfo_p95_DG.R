...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+DG_rsadiff+(1+DG_actmean+DG_rsadiff+p95_actmean|subid)+(1+DG_actmean+DG_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
