...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~CA2_actmean+CA2_rsadiff+p90_actmean+(1+CA2_actmean+CA2_rsadiff+p90_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~p90_actmean+CA2_rsadiff+(1+CA2_actmean+CA2_rsadiff+p90_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~CA2_rsadiff+CA2_actmean+p90_actmean+(1+CA2_rsadiff+CA2_actmean+p90_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~CA2_actmean+p90_actmean+(1+CA2_rsadiff+CA2_actmean+p90_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
