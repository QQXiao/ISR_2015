...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+ERC_rsadiff+(1+ERC_actmean+ERC_rsadiff+p95_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
