...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+CA3_rsadiff+(1+CA3_actmean+CA3_rsadiff+p95_actmean|subid)+(1+CA3_actmean+CA3_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
