...
itemInfo_actmean.null <- lmer(p95_rsadiff~p95_actmean+subiculum_rsadiff+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
