...
subdata <- item_data
itemInfo_actmean <- lmer(IPL_rsadiff~CA2_actmean+CA2_rsadiff+IPL_actmean+(1+CA2_actmean+CA2_rsadiff+IPL_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(IPL_rsadiff~IPL_actmean+CA2_rsadiff+(1+CA2_actmean+CA2_rsadiff+IPL_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(IPL_rsadiff~CA2_rsadiff+CA2_actmean+IPL_actmean+(1+CA2_rsadiff+CA2_actmean+IPL_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(IPL_rsadiff~CA2_actmean+IPL_actmean+(1+CA2_rsadiff+CA2_actmean+IPL_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+IPL_actmean|pid),REML=FALSE,data=subdata)
