...
subdata <- item_data
itemInfo_actmean <- lmer(p90_rsadiff~ERC_actmean+ERC_rsadiff+p90_actmean+(1+ERC_actmean+ERC_rsadiff+p90_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p90_rsadiff~p90_actmean+ERC_rsadiff+(1+ERC_actmean+ERC_rsadiff+p90_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p90_rsadiff~ERC_rsadiff+ERC_actmean+p90_actmean+(1+ERC_rsadiff+ERC_actmean+p90_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p90_rsadiff~ERC_actmean+p90_actmean+(1+ERC_rsadiff+ERC_actmean+p90_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+p90_actmean|pid),REML=FALSE,data=subdata)
