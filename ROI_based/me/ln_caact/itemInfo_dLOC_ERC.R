...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(dLOC_rsadiff~ERC_actmean+ERC_rsadiff+dLOC_actmean+(1+ERC_actmean+ERC_rsadiff+dLOC_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~ERC_rsadiff+dLOC_actmean+(1+ERC_actmean+ERC_rsadiff+dLOC_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~ERC_rsadiff+ERC_actmean+dLOC_actmean+(1+ERC_rsadiff+ERC_actmean+dLOC_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~ERC_actmean+dLOC_actmean+(1+ERC_rsadiff+ERC_actmean+dLOC_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(dLOC_rsaD~ERC_actmean+ERC_rsaD+dLOC_actmean+(1+ERC_actmean+ERC_rsaD+dLOC_actmean|subid)+(1+ERC_actmean+ERC_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~ERC_rsaD+dLOC_actmean+(1+ERC_actmean+ERC_rsadiff+dLOC_actmean|subid)+(1+ERC_actmean+ERC_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsaD~ERC_rsaD+ERC_actmean+dLOC_actmean+(1+ERC_rsaD+ERC_actmean+dLOC_actmean|subid)+(1+ERC_rsaD+ERC_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsaD~ERC_actmean+dLOC_actmean+(1+ERC_rsaD+ERC_actmean+dLOC_actmean|subid)+(1+ERC_rsaD+ERC_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
