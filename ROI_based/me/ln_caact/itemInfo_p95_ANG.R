...
#info_matrx D
itemInfo_actmeanD <- lmer(p95_rsaD~ANG_actmean+ANG_rsaD+p95_actmean+(1+ANG_actmean+ANG_rsaD+p95_actmean|subid)+(1+ANG_actmean+ANG_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(p95_rsaD~ANG_rsaD+p95_actmean+(1+ANG_actmean+ANG_rsadiff+p95_actmean|subid)+(1+ANG_actmean+ANG_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(p95_rsaD~ANG_rsaD+ANG_actmean+p95_actmean+(1+ANG_rsaD+ANG_actmean+p95_actmean|subid)+(1+ANG_rsaD+ANG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(p95_rsaD~ANG_actmean+p95_actmean+(1+ANG_rsaD+ANG_actmean+p95_actmean|subid)+(1+ANG_rsaD+ANG_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
