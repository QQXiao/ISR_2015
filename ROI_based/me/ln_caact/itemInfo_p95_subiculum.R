...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(p95_rsadiff~subiculum_actmean+subiculum_rsadiff+p95_actmean+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~subiculum_rsadiff+p95_actmean+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~subiculum_rsadiff+subiculum_actmean+p95_actmean+(1+subiculum_rsadiff+subiculum_actmean+p95_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~subiculum_actmean+p95_actmean+(1+subiculum_rsadiff+subiculum_actmean+p95_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(p95_rsaD~subiculum_actmean+subiculum_rsaD+p95_actmean+(1+subiculum_actmean+subiculum_rsaD+p95_actmean|subid)+(1+subiculum_actmean+subiculum_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(p95_rsaD~subiculum_rsaD+p95_actmean+(1+subiculum_actmean+subiculum_rsadiff+p95_actmean|subid)+(1+subiculum_actmean+subiculum_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(p95_rsaD~subiculum_rsaD+subiculum_actmean+p95_actmean+(1+subiculum_rsaD+subiculum_actmean+p95_actmean|subid)+(1+subiculum_rsaD+subiculum_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(p95_rsaD~subiculum_actmean+p95_actmean+(1+subiculum_rsaD+subiculum_actmean+p95_actmean|subid)+(1+subiculum_rsaD+subiculum_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
...
write.matrix(r.itemInfo,file="itemInfo_p95_subiculum.txt",sep="\t")
