...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(VVC_rsadiff~ERC_actmean+ERC_rsadiff+VVC_actmean+(1+ERC_actmean+ERC_rsadiff+VVC_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(VVC_rsadiff~ERC_rsadiff+VVC_actmean+(1+ERC_actmean+ERC_rsadiff+VVC_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(VVC_rsadiff~ERC_rsadiff+ERC_actmean+VVC_actmean+(1+ERC_rsadiff+ERC_actmean+VVC_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(VVC_rsadiff~ERC_actmean+VVC_actmean+(1+ERC_rsadiff+ERC_actmean+VVC_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(VVC_rsaD~ERC_actmean+ERC_rsaD+VVC_actmean+(1+ERC_actmean+ERC_rsaD+VVC_actmean|subid)+(1+ERC_actmean+ERC_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(VVC_rsaD~ERC_rsaD+VVC_actmean+(1+ERC_actmean+ERC_rsadiff+VVC_actmean|subid)+(1+ERC_actmean+ERC_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(VVC_rsaD~ERC_rsaD+ERC_actmean+VVC_actmean+(1+ERC_rsaD+ERC_actmean+VVC_actmean|subid)+(1+ERC_rsaD+ERC_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(VVC_rsaD~ERC_actmean+VVC_actmean+(1+ERC_rsaD+ERC_actmean+VVC_actmean|subid)+(1+ERC_rsaD+ERC_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
