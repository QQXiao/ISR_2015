...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(VVC_rsadiff~CA2_actmean+CA2_rsadiff+VVC_actmean+(1+CA2_actmean+CA2_rsadiff+VVC_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(VVC_rsadiff~CA2_rsadiff+VVC_actmean+(1+CA2_actmean+CA2_rsadiff+VVC_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(VVC_rsadiff~CA2_rsadiff+CA2_actmean+VVC_actmean+(1+CA2_rsadiff+CA2_actmean+VVC_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(VVC_rsadiff~CA2_actmean+VVC_actmean+(1+CA2_rsadiff+CA2_actmean+VVC_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(VVC_rsaD~CA2_actmean+CA2_rsaD+VVC_actmean+(1+CA2_actmean+CA2_rsaD+VVC_actmean|subid)+(1+CA2_actmean+CA2_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(VVC_rsaD~CA2_rsaD+VVC_actmean+(1+CA2_actmean+CA2_rsadiff+VVC_actmean|subid)+(1+CA2_actmean+CA2_rsaD+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(VVC_rsaD~CA2_rsaD+CA2_actmean+VVC_actmean+(1+CA2_rsaD+CA2_actmean+VVC_actmean|subid)+(1+CA2_rsaD+CA2_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(VVC_rsaD~CA2_actmean+VVC_actmean+(1+CA2_rsaD+CA2_actmean+VVC_actmean|subid)+(1+CA2_rsaD+CA2_actmean+VVC_actmean|pid),REML=FALSE,data=subdata)
