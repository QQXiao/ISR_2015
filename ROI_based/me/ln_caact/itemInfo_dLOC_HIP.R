...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(dLOC_rsadiff~HIP_actmean+HIP_rsadiff+dLOC_actmean+(1+HIP_actmean+HIP_rsadiff+dLOC_actmean|subid)+(1+HIP_actmean+HIP_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~HIP_rsadiff+dLOC_actmean+(1+HIP_actmean+HIP_rsadiff+dLOC_actmean|subid)+(1+HIP_actmean+HIP_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~HIP_rsadiff+HIP_actmean+dLOC_actmean+(1+HIP_rsadiff+HIP_actmean+dLOC_actmean|subid)+(1+HIP_rsadiff+HIP_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~HIP_actmean+dLOC_actmean+(1+HIP_rsadiff+HIP_actmean+dLOC_actmean|subid)+(1+HIP_rsadiff+HIP_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(dLOC_rsaD~HIP_actmean+HIP_rsaD+dLOC_actmean+(1+HIP_actmean+HIP_rsaD+dLOC_actmean|subid)+(1+HIP_actmean+HIP_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~HIP_rsaD+dLOC_actmean+(1+HIP_actmean+HIP_rsadiff+dLOC_actmean|subid)+(1+HIP_actmean+HIP_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsaD~HIP_rsaD+HIP_actmean+dLOC_actmean+(1+HIP_rsaD+HIP_actmean+dLOC_actmean|subid)+(1+HIP_rsaD+HIP_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsaD~HIP_actmean+dLOC_actmean+(1+HIP_rsaD+HIP_actmean+dLOC_actmean|subid)+(1+HIP_rsaD+HIP_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
