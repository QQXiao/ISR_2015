...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(dLOC_rsadiff~CA2_actmean+CA2_rsadiff+dLOC_actmean+(1+CA2_actmean+CA2_rsadiff+dLOC_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~CA2_rsadiff+dLOC_actmean+(1+CA2_actmean+CA2_rsadiff+dLOC_actmean|subid)+(1+CA2_actmean+CA2_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~CA2_rsadiff+CA2_actmean+dLOC_actmean+(1+CA2_rsadiff+CA2_actmean+dLOC_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~CA2_actmean+dLOC_actmean+(1+CA2_rsadiff+CA2_actmean+dLOC_actmean|subid)+(1+CA2_rsadiff+CA2_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(dLOC_rsaD~CA2_actmean+CA2_rsaD+dLOC_actmean+(1+CA2_actmean+CA2_rsaD+dLOC_actmean|subid)+(1+CA2_actmean+CA2_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~CA2_rsaD+dLOC_actmean+(1+CA2_actmean+CA2_rsadiff+dLOC_actmean|subid)+(1+CA2_actmean+CA2_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsaD~CA2_rsaD+CA2_actmean+dLOC_actmean+(1+CA2_rsaD+CA2_actmean+dLOC_actmean|subid)+(1+CA2_rsaD+CA2_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsaD~CA2_actmean+dLOC_actmean+(1+CA2_rsaD+CA2_actmean+dLOC_actmean|subid)+(1+CA2_rsaD+CA2_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
