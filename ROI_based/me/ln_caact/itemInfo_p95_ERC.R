...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(p95_rsadiff~ERC_actmean+ERC_rsadiff+p95_actmean+(1+ERC_actmean+ERC_rsadiff+p95_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(p95_rsadiff~ERC_rsadiff+p95_actmean+(1+ERC_actmean+ERC_rsadiff+p95_actmean|subid)+(1+ERC_actmean+ERC_rsadiff+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(p95_rsadiff~ERC_rsadiff+ERC_actmean+p95_actmean+(1+ERC_rsadiff+ERC_actmean+p95_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(p95_rsadiff~ERC_actmean+p95_actmean+(1+ERC_rsadiff+ERC_actmean+p95_actmean|subid)+(1+ERC_rsadiff+ERC_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(p95_rsaD~ERC_actmean+ERC_rsaD+p95_actmean+(1+ERC_actmean+ERC_rsaD+p95_actmean|subid)+(1+ERC_actmean+ERC_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(p95_rsaD~ERC_rsaD+p95_actmean+(1+ERC_actmean+ERC_rsadiff+p95_actmean|subid)+(1+ERC_actmean+ERC_rsaD+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(p95_rsaD~ERC_rsaD+ERC_actmean+p95_actmean+(1+ERC_rsaD+ERC_actmean+p95_actmean|subid)+(1+ERC_rsaD+ERC_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(p95_rsaD~ERC_actmean+p95_actmean+(1+ERC_rsaD+ERC_actmean+p95_actmean|subid)+(1+ERC_rsaD+ERC_actmean+p95_actmean|pid),REML=FALSE,data=subdata)
