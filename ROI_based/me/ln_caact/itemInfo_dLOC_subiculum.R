...
resultdir <- paste(basedir,"/me/results/ln_caact",sep="/")
setwd(resultdir)
...
subdata <- item_data
#info_matrix diff
itemInfo_actmean <- lmer(dLOC_rsadiff~subiculum_actmean+subiculum_rsadiff+dLOC_actmean+(1+subiculum_actmean+subiculum_rsadiff+dLOC_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmean.null <- lmer(dLOC_rsadiff~subiculum_rsadiff+dLOC_actmean+(1+subiculum_actmean+subiculum_rsadiff+dLOC_actmean|subid)+(1+subiculum_actmean+subiculum_rsadiff+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff <- lmer(dLOC_rsadiff~subiculum_rsadiff+subiculum_actmean+dLOC_actmean+(1+subiculum_rsadiff+subiculum_actmean+dLOC_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsadiff.null <- lmer(dLOC_rsadiff~subiculum_actmean+dLOC_actmean+(1+subiculum_rsadiff+subiculum_actmean+dLOC_actmean|subid)+(1+subiculum_rsadiff+subiculum_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
#info_matrx D
itemInfo_actmeanD <- lmer(dLOC_rsaD~subiculum_actmean+subiculum_rsaD+dLOC_actmean+(1+subiculum_actmean+subiculum_rsaD+dLOC_actmean|subid)+(1+subiculum_actmean+subiculum_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_actmeanD.null <- lmer(dLOC_rsaD~subiculum_rsaD+dLOC_actmean+(1+subiculum_actmean+subiculum_rsadiff+dLOC_actmean|subid)+(1+subiculum_actmean+subiculum_rsaD+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD <- lmer(dLOC_rsaD~subiculum_rsaD+subiculum_actmean+dLOC_actmean+(1+subiculum_rsaD+subiculum_actmean+dLOC_actmean|subid)+(1+subiculum_rsaD+subiculum_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
itemInfo_rsaD.null <- lmer(dLOC_rsaD~subiculum_actmean+dLOC_actmean+(1+subiculum_rsaD+subiculum_actmean+dLOC_actmean|subid)+(1+subiculum_rsaD+subiculum_actmean+dLOC_actmean|pid),REML=FALSE,data=subdata)
