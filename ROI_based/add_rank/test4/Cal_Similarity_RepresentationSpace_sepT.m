function Cal_Similarity_RepresentationSpace_sepT(r,T)
%%%%%%%%%
...
resultdir1=sprintf('%s/ROI_based/subs_within_between/add_rank/test4/sep_T/method1',basedir);
resultdir2=sprintf('%s/ROI_based/subs_within_between/add_rank/test4/sep_T/method2',basedir);
...
for sf=subs
    ...
    %% all subs ps
    for sff=subs
        ps_ln(sf,sff)=c_rs_ln(all_sub1==sf & all_sub2==sff & check_ln==0);
        ps_mem(sf,sff)=c_rs_mem(all_sub1==sf & all_sub2==sff & check_ln==0);
        ps_ERS(sf,sff)=c_rs_ERS(all_sub1==sf & all_sub2==sff & check_ln==0);
    end
end %end subs
eval(sprintf('save %s/%s_p%d.mat cln cmem cERS Nrank_ln Nrank_mem Nrank_ERS ps_ln ps_mem ps_ERS', resultdir1,roi_name{roi},t));
clear cln cmem cERS Nrank_ln Nrank_mem Nrank_ERS ps_ln ps_mem ps_ERS
%%%Method 2
