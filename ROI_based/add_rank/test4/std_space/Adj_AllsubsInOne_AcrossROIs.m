...
for d=1:length(dir_name);
    datadir=sprintf('%s/ROI_based/subs_within_between/std_space/method%d',basedir,d);
    resultdir=sprintf('%s/ROI_based/subs_within_between/std_space/method%d',basedir,d);
