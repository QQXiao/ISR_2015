function get_representation_space_across_rois(r1,r2)
%%%%%%%%%
...
load(sprintf('%s/all_ln1_%s.mat', datadir,roi_name{roi1}));
all_ln1_roi1=all_ln1_data;
load(sprintf('%s/all_ln2_%s.mat', datadir,roi_name{roi1}));
all_ln2_roi1=all_ln2_data;
load(sprintf('%s/all_mem1_%s.mat', datadir,roi_name{roi1}));
all_mem1_roi1=all_mem1_data;
load(sprintf('%s/all_mem2_%s.mat', datadir,roi_name{roi1}));
all_mem2_roi1=all_mem2_data;
load(sprintf('%s/all_ln1_%s.mat', datadir,roi_name{roi2}));
all_ln1_roi2=all_ln1_data;
load(sprintf('%s/all_ln2_%s.mat', datadir,roi_name{roi2}));
all_ln2_roi2=all_ln2_data;
load(sprintf('%s/all_mem1_%s.mat', datadir,roi_name{roi2}));
all_mem1_roi2=all_mem1_data;
load(sprintf('%s/all_mem2_%s.mat', datadir,roi_name{roi2}));
...
for np=1:1000 %permutation for 1000 times
    ...
    eval(sprintf('save %s/aln_%s_%s.mat aln_z', resultdir,roi_name{roi1},roi_name{roi2}));
    eval(sprintf('save %s/amem_%s_%s.mat amem_z', resultdir,roi_name{roi1},roi_name{roi2}));
    eval(sprintf('save %s/aERS12_%s_%s.mat aERS12_z', resultdir,roi_name{roi1},roi_name{roi2}));
    eval(sprintf('save %s/aERS21_%s_%s.mat aERS21_z', resultdir,roi_name{roi1},roi_name{roi2}));
end %function
