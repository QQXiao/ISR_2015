...
#datadir=$basedir/data_singletrial/ms_LSS/ref_space/merged
datadir=$basedir/data_singletrial/LSS/ref_space/merged
#resultdir=$basedir/data_singletrial/ms_LSS/ref_space/all
resultdir=$basedir/data_singletrial/LSS/ref_space/all
mkdir $resultdir -p
#substart=$1
#subend=$2
